...
import {
  ...
  DEFAULT_VACANCY_AI_CONCURRENCY,
...
export class EnvironmentVariables {
  ...
  /** §4.12.4: обязано совпадать с OLLAMA_NUM_PARALLEL сервиса ollama (config.constants.ts). */
  @IsOptional()
  @Type(() => Number)
  @IsInt()
  @Min(1)
  @Max(VACANCY_AI_CONCURRENCY_MAX)
  VACANCY_AI_CONCURRENCY: number = DEFAULT_VACANCY_AI_CONCURRENCY;
