...
export function applyTestEnvironment(): TestDatabaseSettings {
  ...
  // §4.11.2: троттл фактически снят (заведомо большое значение) — ни один e2e
  // не должен уйти в интернет за выдачей hh.ru. Шаблон ссылки на выдачу больше
  // не env (§3.6, search_url_template) — см. комментарий к TEST_HH_SEARCH_URL_TEMPLATE.
